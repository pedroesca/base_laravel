...
@section('contenido')
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          	<form action="{{route('sucesos.store')}}" method="post" id="formNuevoSuceso">
			          @csrf
			                ...
			                <div class="tab-content col">
			                    ...
			                    <div id="fechas" class="tab-pane fade in active">
			                      ...
			                      <div class="form-group row">
			                          <div class="col-md-4">
			                            ...
			                            <label class="requerido">Fecha de Informe</label>
			                                  <input type="date" id="fecha_informe" name="fecha_informe" class="form-control"{{--  required="true" --}}/>
			                              </p>
			                          </div>
			                          <div class="col-md-4">
			                            <p class="input-group">
			                            <label class="requerido">Hora de Informe</label>
			                                  <input type="time" id="hora_informe" name="hora_informe" class="form-control"/>
			                              </p>
			                          </div>
			                      </div>
			                              ...
			                              <select class="form-control select2" id="factor" name="factor" style="width: 50%;">
			                                <option value ="0">-- Selecciona --</option>
			                             	@foreach($factores as $fac)
			                                	<option value ="{{$fac->id}}">{{$fac->factor}}</option>
			                              	@endforeach
			                              </select>
			                            </div>
			                      </div>
			                      ...
			                      <div class="form-group row">
			                          ...
			                          <div class="col-sm-10">
			                              <input type="text" class="form-control" id="factor_secundario" placeholder="" name="factor_secundario" autocomplete="on">
			                          </div>
			                        </div>
			                    </div>
			                    ...
			                    <div id="details" class="tab-pane fade fade">
			                        ...
			                        <div class="form-group row">
			                          ...
			                          <div class="col-lg-10" >
			                            <input type="text" class="form-control" id="lugar" placeholder="Ingrese la descripción o lugar" name="lugar">
			                          </div>
			                        </div>
